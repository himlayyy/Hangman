...
class App:
    ...
    def viewHighscores(self, file_name):
        ...
        pygame.Surface.blit(self.gameDisplay, startGameButtonText,
                            (625 - startGameButtonText.get_width() // 2, 175 - startGameButtonText.get_height() // 2))
        pygame.Surface.blit(self.gameDisplay, mainMenuButtonText,
                            (625 - mainMenuButtonText.get_width() // 2, 287.5 - mainMenuButtonText.get_height() // 2))
        pygame.Surface.blit(self.gameDisplay, quitGameButtonText,
                            (625 - quitGameButtonText.get_width() // 2, 400 - quitGameButtonText.get_height() // 2))
        pygame.Surface.blit(self.gameDisplay, highscoresTitleText,
                            (400 - highscoresTitleText.get_width() // 2, 75 - highscoresTitleText.get_height() // 2))

        pygame.display.update()

        # These varibles are a list of codinates for the boxes that hold the text
        placeBoxCor = [[25, 125], [25, 175], [25, 225], [25, 275], [25, 325], [25, 375], [25, 425], [25, 475],
                       [25, 525], [25, 575]]
        nameBoxCor = [[75, 125], [75, 175], [75, 225], [75, 275], [75, 325], [75, 375], [75, 425], [75, 475], [75, 525],
                      [75, 575]]
    ...
    def drawMainMenu(self):
        ...
        pygame.Surface.blit(self.gameDisplay, startButtonText,
                            (400 - startButtonText.get_width() // 2, 125 - startButtonText.get_height() // 2))
        pygame.Surface.blit(self.gameDisplay, highscoreButtonText,
                            (400 - highscoreButtonText.get_width() // 2, 275 - highscoreButtonText.get_height() // 2))
        pygame.Surface.blit(self.gameDisplay, quitButtonText,
                            (400 - quitButtonText.get_width() // 2, 425 - quitButtonText.get_height() // 2))
        pygame.display.update()
        ...
        while not user_pick:
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    self._running = False
                # This event makes the button change letter_font when hovered over.
                if event.type == pygame.MOUSEMOTION:
                    mouse_position = pygame.mouse.get_pos()
    ...
    def getWordFile(self):
        try:
            ...
            with open("wordlist.txt", "r"):
                file_name = "wordlist.txt"
        except IOError:
            # If wordlist.txt cannot be found, then we ask the user to specify a text file
            found_file = False
            file_name = input(
                'Please specify a text file containing a list of words for the Hangman game to choose from (include the full file path if the file is in a different directory than the Hangman program): ')
            while not (found_file):
                try:
                    ...
                    file_name = input(
                        '\n{0} was not found!\n\nPlease try again, or specify a different file (include the full file path if the file is in a different directory than the Hangman program): '.format(
                            file_name))
        return file_name
    ...
    def updateInfo(self, score, strike):
        ...
        pygame.Surface.blit(self.infoSurface, scoreTitleText,
                            (70 - scoreTitleText.get_width() // 2, 35 - scoreTitleText.get_height() // 2))
        pygame.Surface.blit(self.infoSurface, scoreText,
                            (70 - scoreText.get_width() // 2, 75 - scoreText.get_height() // 2))
        ...
        pygame.Surface.blit(self.infoSurface, strikeTitle,
                            (70 - strikeTitle.get_width() // 2, 145 - strikeTitle.get_height() // 2))
        pygame.Surface.blit(self.infoSurface, strikeText,
                            (70 - strikeText.get_width() // 2, 187.5 - strikeText.get_height() // 2))
    ...
    def updateLetterGuessed(self, guesses):
        ...
        pygame.Surface.blit(self.lettersGuessedSurface, lettersGuessedTitleText, (
        140 - lettersGuessedTitleText.get_width() // 2, 30 - lettersGuessedTitleText.get_height() // 2))
        ...
        if len(guesses) == 0:
            ...
            pygame.Surface.blit(self.lettersGuessedSurface, lettersGuessed,
                                (140 - lettersGuessed.get_width() // 2, 120 - lettersGuessed.get_height() // 2))
        elif len(guesses) > 0:
        ...
        if user_pick in letters_list:
            ...
            for i in range(len(letters_list)):
                ...
                if blanks_list[i] == '_':
                    ...
                    pygame.Surface.blit(self.wordsSurface, letter,
                                        ((startPos + 10) - letter.get_width() // 2, 75 - letter.get_height() // 2))
                    startPos += 30
        else:
            strikes = strikes + 1
            for i in range(len(letters_list)):
    ...
    def gameOver(self, word, score):
        ...
        pygame.Surface.blit(self.gameDisplay, gameOverTitleText,
                            (400 - gameOverTitleText.get_width() // 2, 67 - gameOverTitleText.get_height() // 2))
        pygame.Surface.blit(self.gameDisplay, wordText,
                            (175 - wordText.get_width() // 2, 150 - wordText.get_height() // 2))
        pygame.Surface.blit(self.gameDisplay, wordText2,
                            (550 - wordText2.get_width() // 2, 150 - wordText2.get_height() // 2))
        ...
        pygame.Surface.blit(self.gameDisplay, startButtonText,
                            (400 - startButtonText.get_width() // 2, 267 - startButtonText.get_height() // 2))
        pygame.Surface.blit(self.gameDisplay, highscoreButtonText,
                            (400 - highscoreButtonText.get_width() // 2, 367 - highscoreButtonText.get_height() // 2))
        pygame.Surface.blit(self.gameDisplay, quitButtonText,
                            (400 - quitButtonText.get_width() // 2, 467 - quitButtonText.get_height() // 2))
    ...
    def playGame(self, score=0):
        ...
        while not user_pick:
            ...
            strikes, game_over, blanks_list = self.updateLetters(chosen_word, word_len, letters_list, blanks_list,
                                                                 user_guess, strikes)
            if game_over:
                if strikes == 6:
                    print('Game Over')
